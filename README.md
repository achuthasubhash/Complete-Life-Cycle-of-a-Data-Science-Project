...
***programming language for data science is Python,R,Julia,Java,Scala,JAVA SCRIPT(Tensorflow.js),etc...*** 
   ...
   Coding Tools Powered by AI : GitHub Co-Pilot,Tabnine,AI2SQL,Mutable,MarsXm,Ghostwriter,Stenography,OpenAI Codex,CodeT5,Polycoder,GhostWriter Replit,Seek,AI2SQL,Cody by Sourcegraph,MutableAI,StableCode,DeciCoder,santacoder,Code Llama
